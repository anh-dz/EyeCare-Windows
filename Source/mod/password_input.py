...
class GET_PASS(QDialog):
    _pass_check_ = None
    def __init__(self, parent=None, change_pass="--Nhập mật khẩu--"):
        ...
        self.enter.setPlaceholderText("Nhập mật khẩu")
...
class GET_WORD(QDialog):
    ...
    def __init__(self, parent=None, text_set=None):
        ...
        QMetaObject.connectSlotsByName(self)
        self.label.setText("--Nhập nội dung--")
